...
<TestClass()> Public Class CompressedIntegerTest
   ...
   Private ReadOnly MIN_1_BYTE_PACKED_INTEGER As Byte() = CompressedInteger.FromInteger(MIN_1_BYTE_INTEGER)
   Private ReadOnly MAX_1_BYTE_PACKED_INTEGER As Byte() = CompressedInteger.FromInteger(MAX_1_BYTE_INTEGER)
   Private ReadOnly MIN_2_BYTE_PACKED_INTEGER As Byte() = CompressedInteger.FromInteger(MIN_2_BYTE_INTEGER)
   Private ReadOnly MAX_2_BYTE_PACKED_INTEGER As Byte() = CompressedInteger.FromInteger(MAX_2_BYTE_INTEGER)
   Private ReadOnly MIN_3_BYTE_PACKED_INTEGER As Byte() = CompressedInteger.FromInteger(MIN_3_BYTE_INTEGER)
   Private ReadOnly MAX_3_BYTE_PACKED_INTEGER As Byte() = CompressedInteger.FromInteger(MAX_3_BYTE_INTEGER)
   Private ReadOnly MIN_4_BYTE_PACKED_INTEGER As Byte() = CompressedInteger.FromInteger(MIN_4_BYTE_INTEGER)
   Private ReadOnly MAX_4_BYTE_PACKED_INTEGER As Byte() = CompressedInteger.FromInteger(MAX_4_BYTE_INTEGER)
...
#Disable Warning S1481 ' Unused local variables should be removed
         Dim junk As Byte() = CompressedInteger.FromInteger(-1)
#Enable Warning S1481 ' Unused local variables should be removed
      ...
      Try
#Disable Warning S1481 ' Unused local variables should be removed
         Dim junk = CompressedInteger.FromInteger(MIN_OVERFLOW_INTEGER)
#Enable Warning S1481 ' Unused local variables should be removed
